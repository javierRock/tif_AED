...
namespace aed
{
    ...
    void MenuConsola::ejecutar()
    {
        while (!_salir && !_entradaCerrada)
        {
            ...
            case 12:
                ...
                break;
            case 13:
                verPublicacionesDeUsuario();
                break;
            case 14:
                interactuarConPublicacion();
                break;
            case 15:
                usuariosMasActivos();
                break;
            case 16:
                publicacionesConMasReacciones();
                break;
            case 17:
                mostrarEstadisticas();
                break;
    ...
    void MenuConsola::buscarUsuario()
    {
        ...
        for (int i = 0; i < mostrados; ++i)
            mostrarLineaDeUsuario(indices[i]);
    }
    ...
    void MenuConsola::verAmigos()
    {
        ...
        linea();
        for (int i = 0; i < mostrados; ++i)
            mostrarLineaDeUsuario(amigos[i]);
    ...
    void MenuConsola::amigosEnComun()
    {
        ...
        for (int i = 0; i < mostrados; ++i)
            mostrarLineaDeUsuario(comunes[i]);
    ...
    void MenuConsola::verPublicacionesDeUsuario()
    {
        ...
        for (int i = 0; i < mostradas; ++i)
            mostrarPublicacion(publicaciones[i], false);
