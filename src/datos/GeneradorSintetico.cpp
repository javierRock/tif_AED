...
namespace aed
{
    ...
    namespace
    {
        ...
        const char *const NOMBRES[] = {
            ...
            "Valeria", "Ernesto", "Milagros", "Alonso", "Fiorella", "Rodrigo", "Katherine", "Cesar",
            "Yesenia", "Marco", "Pilar", "Vicente", "Susana", "Emilio", "Lorena", "Arturo",
            "Nadia", "Ramiro", "Ximena", "Gonzalo", "Camila", "Ignacio", "Roxana", "Mateo",
            "Antonia", "Bruno", "Delia", "Enrique", "Flavia", "Gustavo", "Helena", "Israel",
            "Jimena", "Kevin", "Liliana", "Martin", "Noelia", "Octavio", "Priscila", "Quintin",
            "Rafaela", "Samuel", "Tatiana", "Ulises", "Vania", "Wilmer", "Yolanda", "Zacarias",
            "Abel", "Brenda", "Cristian", "Dalia", "Efrain", "Fabiola", "German", "Hilda",
            "Ismael", "Janeth", "Leonardo", "Magali", "Nicolas", "Olga", "Percy", "Regina",
            "Salvador", "Thalia", "Ubaldo", "Vladimir", "Wendy", "Yeltsin", "Zoila", "Alfonso",
            "Bertha", "Clemente", "Dorotea", "Eduardo", "Francisca", "Genaro", "Herminia", "Isidro"};
        ...
        long long pasoCoprimo(long long total)
        {
            ...
            while (maximoComunDivisor(paso, total) != 1)
                paso += 2;
            return paso;
        }
                                             ...
                                             GeneradorAleatorio &azar)
    {
        ...
        long long desplazamiento =
            static_cast<long long>(parametros.semilla % static_cast<unsigned long long>(total));
                                              ...
                                              GeneradorAleatorio &azar)
    {
        ...
        int nucleo = m + 1;
        if (nucleo > cantidadNodos)
            nucleo = cantidadNodos;
        ...
        for (int nodo = nucleo; nodo < cantidadNodos; ++nodo)
        {
            ...
            while (elegidos.tamanio() < m && intentos < maximoIntentos)
            {
                ...
                if (candidato == nodo || elegidos.contiene(candidato))
                    continue;
            ...
            while (elegidos.tamanio() < m)
            {
                ...
                if (!elegidos.contiene(candidato))
                    elegidos.agregar(candidato);
            }
                                                  ...
                                                  GeneradorAleatorio &azar)
    {
        ...
        int totalUsuarios = red.cantidadPosicionesUsuario();
        if (totalPublicaciones == 0 || totalUsuarios == 0)
            return;
